...
def get_data_loaders(load_img=True, path_full_dataset_a=None, SEED=1, BATCH_SIZE=2, NUM_WORKERS=8, IMAGE_INPUT_SIZE=512, PERCENTAGE_OF_TRAIN_SET_TO_USE=0.7, PERCENTAGE_OF_VAL_SET_TO_USE=0.1):
    ...
    train_transforms = get_transforms("train", IMAGE_INPUT_SIZE)
    val_transforms = get_transforms("val", IMAGE_INPUT_SIZE)
    datasets_as_dfs = get_datasets_as_dfs(path_full_dataset_a, PERCENTAGE_OF_TRAIN_SET_TO_USE, PERCENTAGE_OF_VAL_SET_TO_USE)
...
def get_transforms(dataset: str, IMAGE_INPUT_SIZE):
...
def get_datasets_as_dfs(path_full_dataset_a=None, PERCENTAGE_OF_TRAIN_SET_TO_USE=0.7, PERCENTAGE_OF_VAL_SET_TO_USE=0.1):
